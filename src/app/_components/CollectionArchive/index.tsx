...
export const CollectionArchive: React.FC<Props> = props => {
  ...
  }, [page, categories, relationTo, onResultChange, sort, limit, populateBy, categoryFilters])
...
function cat(value: string, index: number, array: string[]): unknown {
